...
for(const page of pages){
 ...
 for(const src of ['/assets/utm.js?v=20260920','/situation-journeys.js'])if(!html.includes(`src="${src}"`))html=html.replace('<script src="/experience.js"',`<script src="${src}" defer></script>\n<script src="/experience.js"`);
