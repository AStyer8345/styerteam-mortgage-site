...
| Item | Priority |
|------|----------|
| **NEW 2026-05-28 PM: `/scenarios/self-employed-writeoffs-bank-statement.html` is DRAFT** — noindex, NOT in sitemap. Awaiting Adam's real (anonymized) borrower facts. Replace every `[SQUARE BRACKET]`, remove DRAFT comment + noindex meta, add canonical to sitemap, uncomment matching card + Self-Employed chip + All chip on `/scenarios.html` | MEDIUM (Adam) |
...
- **Fill scenario #1** — when Adam provides anonymized borrower facts, replace placeholders in `/scenarios/self-employed-writeoffs-bank-statement.html`, remove noindex, add to sitemap, uncomment hub card + Self-Employed chip.
...
| Resources | first-time-buyer-guide, glossary, how-to-buy, **scenarios (hub + template + 1 DRAFT)**, etc. |
