...
2026-04-28 (styer-suburb-editor-daily) — **Lakeway page deepened (Round 1 slot 10/13).** Median refreshed to $704K Feb 2026 Redfin (-11.2% YoY, $258/sqft, 104 DOM), replacing templated $600K-$2M range. Builder roster added for Rough Hollow 78738 (Drees / David Weekley / Newmark / Scott Felder / Westin) across Vista Ridge Estates / Las Brisas / Canyon Pass / The District; Estates of Flintrock noted as Ashton Woods + Mercury 2017-2023 buildout. Cardinal Hills tagged as 78734 entry tier. New "Major Employers" H3 — Baylor Scott & White Lakeway (106-bed Magnet hospital, "one of the largest employers in the area" per BSW careers) + Hill Country Galleria 1.3M sqft / 285K sqft Class A office (Dillard's/Whole Foods/Cinemark/Dick's/Barnes & Noble anchors). New "Property Tax & Closing Costs" H3 — LTISD $1.0397/$100 (lowest in district history, CitizenPortal cited) + City of Lakeway $0.16964/$100 FY 2025-26 (Community Impact, 6.2% increase, $1,435 avg bill) + Travis County 1.7-2.0% effective per Ownwell; closing-cost breakdown at $704K with 20% down ($563.2K loan) → $14K-$18K itemized + jumbo 6-12mo PITI reserve callout. Schools baked into at-a-glance: Lake Travis HS 9/10 GreatSchools (3324 RR 620 S, 78738) + Serene Hills Elementary 9/10 + 97% grad rate (US News). De-duplicated construction-loan FAQ that was verbatim with Bee Cave; rewrote accordion to Hill Country topography specifics (rock blasting, retaining walls, septic/non-MUD draws). LocalBusiness schema description rewritten w/ zips + neighborhoods; FAQ schema home-prices + construction questions rewritten. WebPage schema added + dateModified 2026-04-28. Meta description: 153 chars w/ Redfin median + GreatSchools + lender count. All 4 JSON-LD blocks validated clean. Sitemap lastmod 2026-04-20 → 2026-04-28. Next queue slot: Bee Cave.
