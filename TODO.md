...
- [ ] **GSC URL Inspection sweep (BLOCKING — Adam manual, escalated 2026-05-04)** — Submit re-indexing for: bee-cave-mortgage-lender.html (**31 days, NEVER INDEXED — `site:` returns zero**), leander-mortgage-lender.html (**push #6 → top 4**, edited 2026-04-28), georgetown-mortgage-lender.html (edited 2026-05-03 — force re-crawl), hutto-mortgage-lender.html (recapture #1 from Big Life), round-rock-mortgage-lender.html (still de-ranked despite indexed), lakeway-mortgage-lender.html (verify schema/AEO).
...
- [ ] **ATX Mortgage Lending watchlist (NEW 2026-05-04)** — re-check `atxmortgagelending.com/sitemap.xml` ≥2026-05-18. NEW core-Austin top-5 entrant explicitly targeting Adam's 9-suburb footprint via body-text only. If they add dedicated suburb pages, first-mover advantage erodes.
